        ...
        try {
            ...
            if (assetFileDescriptor != null) {
                ...
                if (mime.containsKey(MediaFormat.KEY_PCM_ENCODING) &&
                    ...
                    Log.e(
                        TAG,
                        "Expected AudioFormat $EXPECTED_AUDIO_FORMAT, got AudioFormat ${
                ...
                if (mime.containsKey(MediaFormat.KEY_CHANNEL_COUNT) &&
                    ...
                    Log.e(
                        TAG,
                        "Expected $EXPECTED_NUM_CHANNELS channels, got ${mime.getInteger(MediaFormat.KEY_CHANNEL_COUNT)}"
                    )
                    return
                }
                if (mime.containsKey(MediaFormat.KEY_SAMPLE_RATE) &&
                    ...
                    Log.e(
                        TAG,
                        "Expected $EXPECTED_SAMPLE_RATE sample rate, got ${
